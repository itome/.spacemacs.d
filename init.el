...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet undo-tree rainbow-mode nameless mmm-mode lsp-go lsp-mode json-mode js2-mode graphviz-dot-mode evil-unimpaired f s dash diff-hl csv-mode company-statistics company aggressive-indent ace-window avy which-key org-plus-contrib hydra font-lock+ async))))
(custom-set-faces
